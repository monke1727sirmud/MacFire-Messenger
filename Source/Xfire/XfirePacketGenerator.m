...
- (void)generateUInt8:(unsigned char)value
{
	...
	NSLog(@"XfirePacketGenerator: generating uint8 0x%02x",value);
#endif
...
#if GENERATOR_VEBOSE_LOG
	NSLog(@"XfirePacketGenerator: generating uint16 0x%04x",value);
#endif
...
#if GENERATOR_VEBOSE_LOG
	NSLog(@"XfirePacketGenerator: generating uint16 0x%08x",value);
#endif
...
#if GENERATOR_VEBOSE_LOG
	NSLog(@"XfirePacketGenerator: generating uuid %@",uuid);
#endif
...
#if GENERATOR_VEBOSE_LOG
	NSLog(@"XfirePacketGenerator: generating attr key string \"%@\"",str);
#endif
...
#if GENERATOR_VEBOSE_LOG
	NSLog(@"XfirePacketGenerator: generating string \"%@\"",str);
#endif
