...
#if SCANNER_VEBOSE_LOG
	NSLog(@"XfirePacketScanner: scanned uint8 0x%02x",v);
#endif
...
#if SCANNER_VEBOSE_LOG
	NSLog(@"XfirePacketScanner: scanned uint16 0x%04x",v);
#endif
...
#if SCANNER_VEBOSE_LOG
	NSLog(@"XfirePacketScanner: scanned uint32 0x%08x",v);
#endif
...
#if SCANNER_VEBOSE_LOG
	NSLog(@"XfirePacketScanner: scanned uint64 0x%016llx",v);
#endif
...
#if SCANNER_VEBOSE_LOG
	NSLog(@"XfirePacketScanner: scanned uuid %@",v);
#endif
...
#if SCANNER_VEBOSE_LOG
	NSLog(@"XfirePacketScanner: scanned attr key string \"%@\"",s);
#endif
...
#if SCANNER_VEBOSE_LOG
		NSLog(@"XfirePacketScanner: scanned string \"%@\"",s);
#endif
...
- (BOOL)scan:(unsigned int *)packetID attributes:(XfirePacketAttributeMap **)attrsOut
{
	...
	if( ![self isAtEnd] )
	{
		NSLog(@"XfirePacketScanner: Stopped scanning but more data remains");
	}
...
- (XfirePacketAttributeMap *)scanAttributeMapInDomain:(XfireAttributeKeyDomain)domain
{
	...
	if( domain == kXfireAttributeKeyIntegerDomain )
		NSLog(@"XfirePacketScanner: scanning attr map in integer domain");
	else
		NSLog(@"XfirePacketScanner: scanning attr map in string domain");
#endif
...
#if SCANNER_VEBOSE_LOG
	NSLog(@"XfirePacketScanner: attr key = %@", key);
#endif
